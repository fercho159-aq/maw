      ...
      <section className="py-16 bg-card">
        <div className="container mx-auto px-4 md:px-6 text-center">
          <div className="max-w-3xl mx-auto">
            <ListTodo className="w-16 h-16 mx-auto mb-6 text-primary" />
            ...
            <p className="mt-6 text-lg sm:text-xl text-foreground/80">
              Envía recordatorios y resúmenes diarios automáticos a tus empleados sobre sus tareas y pendientes para mejorar la productividad.
            </p>
          </div>
        </div>
      </section>
