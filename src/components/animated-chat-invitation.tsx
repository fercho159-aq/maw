  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-4 min-h-[220px]">
        ...
        >
          <p>¡Hola! Somos MAW Soluciones. ¿En qué podemos ayudarte hoy?</p>
        </motion.div>
        ...
        >
          <Button
            onClick={() => {
              window.open("https://wa.me/525538359927?text=" + encodeURIComponent("Hola, quiero más información sobre sus servicios."), "_blank");
            }}
