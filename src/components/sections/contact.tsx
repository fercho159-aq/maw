          ...
          <AnimatedDiv className="bg-card p-8 rounded-lg shadow-lg" transition={{ delay: 0.2 }}>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-4">
                ...
                <a href="https://wa.me/5538359927?text=Hola%2C%20me%20interesa%20trabajar%20con%20ustedes.%20%C2%BFPor%20d%C3%B3nde%20empezamos%3F" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">55 4131 4150</a>
              </div>
              <div className="flex items-center gap-4">
